                                        ...
                                        <div class="p-img lz">
                                            @php
                                                $img = DB::table('product_images')
                                                    ...
                                                    : 'products/default.jpg';
                                            @endphp
                                            <img src="{{ env('APP_URL') . 'content/' . $img }}" alt="product" loading="lazy"
                                                height="100">
                                        </div>
                                    </div>

                                    <div class="p-s2">
                                        <div class="p-t">Loose-fitting oxford shirt with front buttons</div>

                                        <div class="p-pr-w">
                                            <div class="p-pr1">
                                                <div class="p-cur">R.H.</div> 120.00
                                            </div>
                                            <div class="p-pr2">
                                                <div class="p-cur">R.H.</div> 200.00
                                            </div>
                                        </div>
