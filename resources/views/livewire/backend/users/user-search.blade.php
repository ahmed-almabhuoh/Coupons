            ...
            <div class="col-sm-12 col-md-8 col-lg-6 ps-xl-75 ps-0">
                <div
                    ...
                    <div class="dt-buttons btn-group flex-wrap">
                        <a href="{{ route('users.create') }}" class="btn add-new btn-primary mt-50">
                ...
                @foreach ($users as $user)
                    <tr>
                        <td>
                            @if ($user->image)
                                <span class="avatar"><img class="round"
                                        src="{{ env('APP_URL') . 'human/' . $user->image }}" alt="avatar"
                                        height="40" width="40">
                                    @if ($user->is_active)
                        ...
                        <td>
                            ...
                            <button type="button"
                                onclick="confirmationDelete('{{ Crypt::encrypt($user->id) }}', this)"
