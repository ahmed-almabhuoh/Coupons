            ...
            <div class="col-sm-12 col-md-8 col-lg-6 ps-xl-75 ps-0">
                <div
                    ...
                    <div class="dt-buttons btn-group flex-wrap">
                        <a href="{{ route('coupons.create') }}" class="btn add-new btn-primary mt-50">
                ...
                @foreach ($coupons as $coupon)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('coupons.edit', Crypt::encrypt($coupon->id)) }}"
                            ...
                            <button type="button"
                                onclick="confirmationDelete('{{ Crypt::encrypt($coupon->id) }}', this, '{{ auth('admin')->user()->lang }}')"
