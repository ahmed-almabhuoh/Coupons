            ...
            <div class="col-sm-12 col-md-8 col-lg-6 ps-xl-75 ps-0">
                <div
                    ...
                    <div class="dt-buttons btn-group flex-wrap">
                        <a href="{{ route('serials.create') }}" class="btn add-new btn-primary mt-50">
                            <span>{{ __('Add New Serial') }}</span>
                        </a>
                    </div>
                </div>
            </div>
                        ...
                        @if (auth()->user()->can('delete-serial') ||
                            ...
                            <td>
                                ...
                                @if (auth()->user()->can('edit-serial'))
                                    <a href="{{ route('serials.edit', Crypt::encrypt($serial->id)) }}"
                                ...
                                @if (auth()->user()->can('delete-serial'))
                                    <button type="button"
                                        onclick="confirmationDelete('{{ Crypt::encrypt($serial->id) }}', this, '{{ auth('admin')->user()->lang }}')"
