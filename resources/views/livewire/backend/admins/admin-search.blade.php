            ...
            <div class="col-sm-12 col-md-8 col-lg-6 ps-xl-75 ps-0">
                <div
                    ...
                    <div class="dt-buttons btn-group flex-wrap">
                        <a href="{{ route('admins.create') }}" class="btn add-new btn-primary mt-50">
            ...
            <thead class="table-light">
                <tr role="row">
                    ...
                    <th class="sorting sorting_desc" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                        colspan="1" style="width: 112.094px;" aria-sort="descending"
                        aria-label="Email: activate to sort column ascending">{{ __('E-mail') }}</th>
                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
                        style="width: 102.453px;" aria-label="Plan: activate to sort column ascending">
                        {{ __('Phone') }}</th>
                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
                    ...
                    <tr>
                        ...
                        <td>
                            @if (count($admin->roles))
                                <a href="{{ route('roles.edit', Crypt::encrypt($admin->roles->first()->id)) }}">
                        ...
                        @if (auth()->user()->can('delete-admin') ||
                            ...
                            <td>
                                ...
                                @if (auth()->user()->can('delete-admin'))
                                    <button type="button"
                                        onclick="confirmationDelete('{{ Crypt::encrypt($admin->id) }}', this, '{{ auth('admin')->user()->lang }}')"
