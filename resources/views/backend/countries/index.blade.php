...
@section('content')
    ...
    <div class="content-body">
        ...
        <section class="app-user-list">
            <div class="card">
                <livewire:backend.countries.country-search />
            </div>
            <!-- list section end -->
        </section>
        <!-- countries list ends -->
...
@section('scripts')
    <!-- BEGIN: Page JS-->
    <script src="{{ asset('panel/app-assets/js/scripts/pages/app-country-list.js') }}"></script>
    <!-- END: Page JS-->
    ...
    <script>
        ...
        function deleteAdmin(id, refrance) {
            axios.delete('/cpanel/countries/' + id)
                .then((response) => {
